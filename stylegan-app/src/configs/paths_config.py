...
model_paths = {
	...
	'shape_predictor': '/workspace/stylegan-app/src/pretrained_models/shape_predictor_68_face_landmarks.dat',
	...
	'faces_w_encoder': '/workspace/stylegan-app/src/pretrained_models/faces_w_encoder.pt',
	...
	'restyle_e4e_ffhq': '/workspace/stylegan-app/src/pretrained_models/restyle_e4e_ffhq_encode.pt',
	...
	'STYLEGAN_CKPT': '/workspace/stylegan-app/src/pretrained_models/ffhq.pkl',
	'pca': 'pretrained_models/ffhq_pca.pt',
	'checkpoint_path': '/workspace/stylegan-app/src/pretrained_models/hyperstyle_ffhq.pt'
}
